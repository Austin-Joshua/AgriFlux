          ...
          <div className="space-y-3">
            <div className="flex justify-between text-sm">
              ...
              <span className="font-bold text-gray-800 dark:text-gray-100">
                ₹{(data.profitMax + data.estimatedCost).toLocaleString()}
              </span>
            </div>
            <div className="flex justify-between text-sm">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="p-4 rounded-2xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-800/20">
            ...
            <div className="flex items-center gap-2">
              <div
                className={`w-2 h-2 rounded-full ${rainRisk === 'Low' ? 'bg-green-500' : 'bg-yellow-500'}`}
              />
          ...
          <div className="p-4 rounded-2xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-800/20">
            ...
            <div className="flex items-center gap-2">
              <div
                className={`w-2 h-2 rounded-full ${marketRisk === 'Low' ? 'bg-green-500' : 'bg-yellow-500'}`}
              />
