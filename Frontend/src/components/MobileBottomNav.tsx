...
import { LayoutDashboard, Store, Tractor, Leaf, Map, Sparkles } from 'lucide-react';
            ...
            const fab =
              i === 2 ? (
                ...
                >
                  ...
                  <span className="text-[10px] font-semibold text-primary-600 dark:text-primary-400 mt-1">
                    AI Report
                  </span>
                </button>
              ) : null;
