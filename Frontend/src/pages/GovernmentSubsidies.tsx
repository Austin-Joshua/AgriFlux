...
const schemes: Scheme[] = [
  {
    ...
    benefit:
      '₹6,000/year direct income support in 3 equal instalments to small & marginal farmers.',
  ...
  },
  {
    ...
    category: 'Insurance',
    benefit:
      'Financial support to farmers suffering crop loss due to unforeseen calamities, pests & diseases.',
    eligibility: 'All farmers including sharecroppers & tenant farmers growing notified crops.',
    maxBenefit: 'Up to full sum insured',
    state: 'All India',
  ...
  },
  {
    ...
    benefit:
      'Free soil testing and a card containing crop-wise nutrient recommendations for every farmer.',
    eligibility: 'All farmers.',
    maxBenefit: 'Free soil analysis',
    state: 'All India',
    url: 'https://soilhealth.dac.gov.in',
    tags: ['Soil', 'Free Service'],
    icon: '🧪',
  },
  {
    id: 'kcc',
    ...
    category: 'Credit',
    benefit:
      'Short-term credit at 4% interest for crop cultivation, post-harvest expenses, and allied activities.',
    eligibility: 'Farmers, tenant farmers, oral lessees and SHG/JLG members.',
    maxBenefit: 'Up to ₹3 Lakh @ 4% interest',
    state: 'All India',
    url: 'https://www.nabard.org/content.aspx?id=595',
    tags: ['Credit', 'Loan'],
    icon: '💳',
  },
  {
    ...
    benefit:
      'Online trading platform connecting farmers, APMCs, traders, and buyers for better price discovery.',
    eligibility: 'All farmers with produce to sell.',
    maxBenefit: 'Better market prices',
    state: 'All India',
  ...
  {
    id: 'rkvy',
    name: 'RKVY — Krishi Vikash Yojana',
    ministry: 'Ministry of Agriculture',
    category: 'Development',
    benefit:
      'State-level agriculture development projects funding — infrastructure, post-harvest management, and more.',
    eligibility: 'Project-based; implemented via State governments.',
    maxBenefit: 'Project-specific',
    state: 'State-wise',
  ...
  },
  {
    ...
    benefit:
      'Subsidy for fruits, vegetables, mushrooms, spices, flowers, plantation crops and post-harvest infrastructure.',
    eligibility: 'Individual farmers, FPOs, and companies in horticulture.',
    maxBenefit: 'Up to 50% of project cost',
    state: 'All India',
    url: 'https://www.midh.gov.in',
    tags: ['Horticulture', 'Subsidy'],
    icon: '🍅',
  },
  {
    id: 'atma',
    name: 'ATMA — Agricultural Technology',
    ministry: 'Ministry of Agriculture',
    category: 'Training',
    benefit:
      'Training and demonstration for farmers including farmer field schools, exposure visits, and skill development.',
    eligibility: 'All farmers.',
    maxBenefit: 'Free training & TA',
    state: 'All India',
    url: 'https://atma-dac.gov.in',
  ...
  },
  {
    ...
    category: 'Irrigation',
    benefit:
      'Subsidy for micro-irrigation (drip & sprinkler), water conservation, and watershed development.',
    eligibility: 'Individual farmers; priority to small/marginal.',
    maxBenefit: '55% subsidy (small/marginal)',
    state: 'All India',
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
        ...
        <div className="flex items-center gap-2 text-sm bg-amber-50 dark:bg-amber-900/20 text-amber-700 dark:text-amber-400 px-4 py-2 rounded-xl border border-amber-200 dark:border-amber-800">
          ...
          <span className="font-semibold">
            {schemes.length} {t('subsidies.activeSchemes')}
          </span>
        </div>
      </div>
      ...
      <p className="text-xs text-gray-400 dark:text-gray-500 font-medium">
        {filtered.length} {t('subsidies.found')}
      </p>
      ...
      <div className="standard-grid">
        {filtered.map((scheme) => (
          ...
          >
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300 mb-3 flex-1 leading-relaxed">
              {scheme.benefit}
            </p>
      ...
      <div className="card bg-blue-50/50 dark:bg-blue-900/10 border-blue-200 dark:border-blue-800/50">
        <p className="text-xs text-blue-600 dark:text-blue-400 flex items-start gap-2">
          ...
          <span>
            <strong>Disclaimer:</strong> {t('subsidies.disclaimer')}
          </span>
        </p>
      </div>
    </div>
