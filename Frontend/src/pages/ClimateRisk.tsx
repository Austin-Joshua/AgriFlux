...
const tempData = [
  { month: 'Jan', min: 12, max: 28 },
  { month: 'Feb', min: 14, max: 31 },
  { month: 'Mar', min: 18, max: 35 },
  { month: 'Apr', min: 22, max: 38 },
  { month: 'May', min: 24, max: 40 },
  { month: 'Jun', min: 22, max: 36 },
];
  ...
  const alerts = [
    {
      ...
      title: 'Heatwave Risk',
      body: 'Temperatures 3°C above seasonal average expected next week. Risk of crop stress for sensitive crops.',
    },
    {
      type: 'info',
      icon: Droplets,
      ...
      title: 'Monsoon Onset',
      body: 'Southwest monsoon expected to arrive in 12 days. Prepare drainage to prevent waterlogging.',
    },
    {
      type: 'success',
      icon: Wind,
      ...
      title: 'Favorable Wind Conditions',
      body: 'Moderate northeasterly winds will aid pollination for flowering crops this week.',
    },
  ];
        ...
        <div className="card glass-gold border-gold-300 dark:border-gold-800/40 flex flex-col items-center justify-center text-center">
          ...
          <div className="relative w-36 h-36 mb-3">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <span className="text-4xl font-black text-gold-600 dark:text-gold-400 font-display">
                {riskScore}
              </span>
          ...
          <p className="text-[11px] text-gray-500 dark:text-gray-400 mt-3 font-medium">
            Favorable conditions for rice cultivation continue
          </p>
