...
> = {
  Rice: {
    ...
    yieldMin: 3800,
    yieldMax: 5200,
    bestMarket: 'Andhra Pradesh & Telangana Mandis',
    factors: [
      'High water availability',
      'Loamy soil suitable',
      'Strong mandis nearby',
  ...
  Wheat: {
    ...
    yieldMin: 3500,
    yieldMax: 5000,
    bestMarket: 'Punjab & Haryana APMCs',
    factors: [
      'Neutral soil pH optimal',
      'Rabi season timing ideal',
      'MSP support available',
      'Cold weather favourable',
    ],
  },
  Cotton: {
    variety: 'BT Hybrid',
    ...
    yieldMin: 1200,
    yieldMax: 2200,
    bestMarket: 'Vidarbha & Gujarat Mandis',
    factors: [
      'Black cotton soil detected',
  ...
  Maize: {
    ...
    yieldMin: 4200,
    yieldMax: 6000,
    bestMarket: 'Karnataka & MP APMCs',
    factors: [
      'Moderate rainfall support',
      'Good soil drainage',
      'Poultry industry demand',
      'STAPLE hybrid performance',
    ],
  },
  Sugarcane: {
    variety: 'Co 86032',
    ...
    yieldMin: 60000,
    yieldMax: 85000,
    bestMarket: 'Western UP & Maharashtra',
    factors: [
      'Sandy-loam soil ideal',
      'River irrigation access',
      'Sugar mills proximity',
      'Govt quota secured',
    ],
  },
  Tomatoes: {
    ...
    yieldMin: 20000,
    yieldMax: 40000,
    bestMarket: 'Kolar (Karnataka) & Nashik',
    factors: [
      'Pest resistance noted',
      'High storage quality',
      'Market shortage detected',
  ...
  Soybeans: {
    ...
    yieldMin: 1800,
    yieldMax: 2800,
    bestMarket: 'Madhya Pradesh APMCs',
    factors: [
      'Nitrogen fixation active',
      'Short duration variety',
      'Oil content above average',
      'Reliable monsoon cycle',
    ],
  },
  Onion: {
    ...
    yieldMin: 15000,
    yieldMax: 25000,
    bestMarket: 'Lasalgaon (Nashik), Maharashtra',
    factors: [
      'Stable market demand',
      'Bulb quality premium',
      'Low input cost detected',
      'High storage longevity',
    ],
  },
};
...
export function useRealisticData(crop: CropKey = SESSION_CROP): RealisticCropData {
  return useMemo(() => {
    ...
    const profitMax = Math.round((revMax * 0.6) / 1000) * 1000; // ~60% margin
